...
// Both sides reach here through normalizePathResource()'s resolve(), so they are
// always spelled in the host separator. Anchoring on `sep` rather than a literal
// "/" is what makes containment work on Windows, where resolve() answers `\repo\x`
// and a "/"-anchored prefix test can never match — collapsing every path rule to
