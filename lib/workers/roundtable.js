...
export function buildManifestoPrompt(userText, character) {
  ...
  return `PHASE: MANIFESTO\nThe round-table discussion has concluded${charContext}. The original question was:\n\n> ${quoteBlock(userText)}\n\nWrite your personal manifesto — a concise final statement of your convictions on this matter. This is not a summary of the discussion or the consensus. It is your individual voice, your principles, your final word.\n\nKeep it under 200 words. Be direct. Be personal. This is what you stand for.`;
}
