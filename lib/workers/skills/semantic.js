...
// process pays only the one message embedding per rescued turn. Unbounded by
// design: the key space is the on-disk skill set, which is small and
// operator-controlled, not user-generated — no eviction needed.
