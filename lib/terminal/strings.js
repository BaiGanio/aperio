...
export const EN = {
  ...
  welcome_stop_hint:      "Press Esc to stop a reply while it's being written.",

  // help shell
  help_title:        "How to talk to Aperio",
  help_intro:        "Mostly, just type what you want in plain words. The commands below\n  start with a slash (/) — type one on its own line.",
  ...
  desc_self:      "see the notes I've kept for myself (local only)",
  ...
  desc_config:    "show effective config values and where they came from",
  ...
  detail_config:    "Print every config value currently in effect and whether it came from\n  .env, the Settings panel (DB), or the built-in default. Use this to\n  diagnose which layer a value is actually coming from.",
