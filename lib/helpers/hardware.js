...
// probe used only for reporting today — context sizing still keys off RAM
// (see recommendContextLength in lib/providers/index.js; model choice is a
// single fixed default, not RAM-tiered), so a wrong or missing VRAM read
// never breaks a sizing decision, only a diagnostic readout.
import os from "os";
