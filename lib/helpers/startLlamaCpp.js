...
import { writeFileSync, readFileSync, existsSync, mkdirSync, openSync, closeSync, copyFileSync, unlinkSync } from "fs";
...
const GENERIC_MODEL_FACTS = { sizeGB: 8, maxContext: 131072, kvBytesPerToken: 524288 };
...
// Each chat session gets its own copy of the shared server.log so it can be
