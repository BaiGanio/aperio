...
// prompt-cache warm-up request (trash/plans/prompt-cache-hygiene, WS2): firing
// a warm-up while the model is still loading would race the load rather than
// help it, so callers should skip warming entirely when this is false.
