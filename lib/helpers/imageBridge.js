...
// progress/log text. Always the curated default (gemma-4-E4B), never
// defaultLocalModel() — that would echo back a blind configured main model
// instead of the model that's actually acting as the eyes.
const VLM_MODEL = DEFAULT_LOCAL_MODEL;
