...
export const CONFIG = [
  ...
  { key: "AI_PROVIDER", section: "essentials", type: "select", tier: 1, show: "set",
    default: "", example: "ollama", liteDefault: "ollama",
    options: ["anthropic", "deepseek", "gemini", "ollama", "llamacpp", "claude-code", "codex"],
  ...
  { key: "OLLAMA_VLM_TIMEOUT_MS", section: "timeouts", type: "number", tier: 1, show: "commented",
    default: "300000", help: "Timeout for the local VLM image-analysis bridge (OLLAMA_VLM_MODEL)." },
  ...
  { key: "IDLE_SHUTDOWN", section: "server", type: "select", tier: 1, show: "commented",
    ...
    help: "Idle auto-shutdown after the last browser tab closes. 'auto' = on only for the local Ollama provider; 'on' = always (the lite desktop launchers set this so a windowless/hidden server still self-stops on any provider); 'off' = never (for always-on server deployments)." },
