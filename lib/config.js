...
export const CONFIG = [
  ...
  { key: "APERIO_MODEL_FACTS_OVERRIDES", section: "llamacpp", type: "text", tier: 1, show: "commented",
    default: "",
    help: "JSON object keyed by HF repo path (with optional :quant suffix) overriding the curated MODEL_FACTS dict for uncached or custom models. Each value has { sizeGB, maxContext, kvBytesPerToken, architecture?, activeParams? }. Slotted between GGUF inspection and the curated catalog in resolveModelFacts." },
