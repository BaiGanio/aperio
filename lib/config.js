...
export const SECTIONS = [
  ...
  { id: "llamacpp", title: "llama.cpp (local) extras", group: "features",
    blurb: "Not yet a selectable AI_PROVIDER — lifecycle-only plumbing for the in-progress Ollama replacement. Defaults shown — override only once wired up." },
...
export const CONFIG = [
  ...
  { key: "AI_PROVIDER", section: "essentials", type: "select", tier: 1, show: "set",
    ...
    options: ["anthropic", "deepseek", "gemini", "ollama", "claude-code", "codex"],
