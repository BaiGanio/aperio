...
export const CONFIG = [
  ...
  { key: "LLAMA_CACHE", section: "llamacpp", type: "path", tier: 1, show: "commented",
    default: "./var/models",
    help: "Where llama-server caches downloaded GGUF weights (Hugging Face hub cache layout). Shared by the vendored server and the setup wizard's model-presence check, so both agree on one location." },
