...
export const CONFIG = [
  ...
  { key: "CODEX_TURN_MAX_TOOL_CALLS", section: "essentials", type: "number", tier: 1, show: "commented",
    default: "32", help: "Maximum Codex tool/action items allowed in one turn. Set to 0 to disable this guardrail." },
  { key: "CODEX_TURN_MAX_PROCESSED_TOKENS", section: "essentials", type: "number", tier: 1, show: "commented",
    default: "250000", help: "Maximum aggregate processed input tokens reported for one Codex turn. Because the CLI reports this at turn completion, enforcement occurs when usage arrives. Set to 0 to disable it." },
  { key: "CODEX_TURN_MAX_SECONDS", section: "essentials", type: "number", tier: 1, show: "commented",
    default: "900", help: "Maximum wall-clock seconds for one Codex turn. Set to 0 to disable this guardrail." },
