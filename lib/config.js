...
export const CONFIG = [
  ...
  { key: "APERIO_LITE", section: "essentials", type: "boolean", tier: 1, show: "commented",
    default: "", example: "on",
    help: "Lite profile for non-technical users (the desktop launchers set it). Currently selects the non-coder starter memory set on first boot; UI simplification will follow. Off unless set to exactly 'on'." },
