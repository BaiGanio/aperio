...
export const CONFIG = [
  ...
  { key: "LLAMACPP_MODEL", section: "llamacpp", type: "text", tier: 1, show: "commented",
    ...
    help: "Hugging Face repo[:quant] for the main model (llama-server -hf format). Also used as the router-preset model name and the `model` field sent on /v1/chat/completions." },
