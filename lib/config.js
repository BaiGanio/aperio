...
export const CONFIG = [
  ...
  { key: "APERIO_TOOL_RESULT_OFFLOAD_BYTES", section: "toolsafety", type: "number", tier: 1, show: "commented",
    default: "80000",
    help: "Store a complete tool result outside model context when its redacted UTF-8 content exceeds this byte count. 0 disables the byte threshold; the token threshold still applies." },
