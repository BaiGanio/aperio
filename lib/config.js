...
//   envTemplate → emitted into the slim .env.example (tier-0 bootstrap keys +
//                 the START-HERE provider block; everything else lives in the
//                 generated docs/config-reference.md and still works in .env)
