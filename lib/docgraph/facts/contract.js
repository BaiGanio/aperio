 ...
 * the two languages this corpus is written in. This is a starting taxonomy,
 * not a claim of universal coverage: an unmatched charge becomes an explicit
...
export const CATEGORY_RULES = [
  ...
  { category: "Dining", patterns: [/restaurant/i, /ресторант/i, /\bcafé\b/i, /\bcafe\b/i, /кафене/i, /bistro/i] },
