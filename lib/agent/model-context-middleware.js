        ...
        return {
          update: {
            ...
            promptParts: skillPrompts.length
              ...
              : request.promptParts,
            // Exposed separately so providers with small context windows can
            // rebuild the system prompt without them when the assembled request
            // would not fit (matched skills can add thousands of tokens).
