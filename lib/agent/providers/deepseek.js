...
import { ToolExecutor, countTrailingRepeatedToolCalls, TOOL_REPEAT_LIMIT, TOOL_REPEAT_NUDGE } from "../../tools/executor.js";
...
export async function runDeepSeekLoop(messages, emitter, opts = {}, getAbort = () => null, setAbort = () => {}, ctx) {
  ...
  while (true) {
    ...
    const streamHandler = new LlamaCppStreamHandler(response, emitter, reasoningAdapter, callTool, provider);
