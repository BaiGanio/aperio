...
export async function createAgent({ root, version, clientName = "Aperio-agent", providerConfig = null, persona = null, character = null, spec = null } = {}) {
  const agentSpec = resolveCreateAgentSpec({ spec, clientName, providerConfig, persona, character });
  ...
  const agentObj = {
    provider, mcpTools, spec: agentSpec, persona, character, artifactStore,
    greetingToolCount,
    getSystemPrompt,
    getAnthropicTools,
    getOllamaTools,
