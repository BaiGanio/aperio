...
import { classifyDeliverable, persistAnswerArtifacts } from "./deliverables.js";
...
export { classifyDeliverable, persistAnswerArtifacts };
...
export async function createAgent({ root, version, clientName = "Aperio-agent", providerConfig = null, persona = null, character = null, spec = null, bundleDir = null, hostTools = [] } = {}) {
  ...
  const {
    ...
    root, clientName, version, provider, hostTools,
  ...
  const agentObj = {
    ...
    async runAgentLoop(messages, emitter, opts = {}, getAbort = () => null, setAbort = () => {}) {
      ...
      checkNoToolUse({
        ...
        toolCallCount: hooks.toolSeq.value, noTools: opts.noTools,
      });
