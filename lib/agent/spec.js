...
export const AGENT_PROVIDERS = Object.freeze([
  ...
  "claude-code",
  "codex",
  // Deterministic loop-regression harness only (tests/harness/). This list only
  // validates AgentSpec shape; resolveProvider() (lib/providers/index.js) is the
  // authoritative gate that refuses to actually resolve "mock" outside
  // NODE_ENV=test, so allowing it here does not widen what can execute.
  "mock",
]);
