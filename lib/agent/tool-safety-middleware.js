...
export function createToolSafetyMiddleware({
  ...
  const middleware = [
    ...
    },
    {
      ...
      // usually answer from what it already has. That is the only backstop
      // anthropic.js/gemini.js get today (their loops are `while (true)` with
      // no step cap and no dedup cache of their own).
      //
