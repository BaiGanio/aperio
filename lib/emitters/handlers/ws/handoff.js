...
export async function handleHandoff(focus, { messages, sessionId, currentLang, runAgentLoop, emitter, sessionLogger, send, firstMessageSynthetic = false }) {
  ...
  try { appendSummary(sessionId, { content: doc, messages, firstMessageSynthetic }); } catch { /* non-fatal */ }
