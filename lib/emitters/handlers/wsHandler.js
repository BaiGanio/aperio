 ...
 */
export function makeWsHandler({ agent, primaryRoundtable = null, verifier = null, roundtableAvailable = false, roundtableUnavailableReason = null, store, __dirname, isShuttingDown = () => false }) {
        ...
        try {
          ...
          switch (data.type) {
            ...
            case "chat": {
              ...
              await activeTurn;
              send("turn_complete", { turnId, status: "completed" });
              return;
            }
