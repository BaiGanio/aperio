-- 011_model_facts.sql — Postgres
-- Curated llama.cpp sizing metadata, replacing the source-code MODEL_FACTS map.
-- Mirror of db/migrations-sqlite/011_model_facts.sql — keep in lockstep.

CREATE TABLE model_facts (
  alias              TEXT PRIMARY KEY,
  hf                 TEXT NOT NULL,
  size_gb            DOUBLE PRECISION NOT NULL CHECK (size_gb > 0),
  ...
  active_params      DOUBLE PRECISION,
  mmproj             TEXT
);
