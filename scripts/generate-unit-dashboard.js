...
// Converts the unit test reporter output into docs/benchmarks/unit/unit-data.js.
...
const outputPath = resolve(ROOT, option("--output", "docs/benchmarks/unit/unit-data.js"));
