...
Detailed sub-plan and companion tests deleted 2026-08-13 on closure; recover with
`git log -- trash/plans/document-intelligence-epic/document-intelligence-ws3-templates.md`
if the review history is ever needed again.
