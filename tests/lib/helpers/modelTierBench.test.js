...
test("the checked-in qualification suite is the canonical 14-case funnel", () => {
  const suite = JSON.parse(readFileSync(".github/model-tiers/cases.json", "utf8"));
...
test("the qualification memory fixture is exactly 28 tagged memories", () => {
  ...
  const contract = JSON.parse(readFileSync(".github/model-tiers/fixture-contract.json", "utf8"));
