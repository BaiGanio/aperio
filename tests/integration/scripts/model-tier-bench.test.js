...
const FULL_EXAM = validateFullExamManifest(JSON.parse(readFileSync(join(REPO_ROOT, "docs/benchmarks/tools/full-exam.json"), "utf8")));
...
test("catalog contains the user's verified candidate matrix", () => {
  const models = JSON.parse(readFileSync("docs/benchmarks/tools/models.json", "utf8"));
