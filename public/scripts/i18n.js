...
const TRANSLATIONS = {
  en: {
    ...
    skill_chips_toggle_title: "Skill shortcuts",
    skill_chips_more:         "+{n} more",
    skill_chips_less:         "− less",
    ...
    plus_menu_branch_desc:    "Save this chat and open a fresh thread that remembers the gist. Come back anytime from Sessions.",
    branch_button_label:      "Branch",
    branch_button_tooltip:    "Save this chat and start a fresh thread that remembers the gist — the original stays in Sessions",
    branch_card_title:        "Branch this conversation?",
    branch_card_body:         "Everything here is saved as-is. A new thread opens with a short summary of this one, so you can chase the tangent without losing the plot. The original stays one click away in Sessions.",
    branch_card_go:           "Branch it",
